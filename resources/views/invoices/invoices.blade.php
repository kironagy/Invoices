            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <a href="invoices/create" class="modal-effect btn btn-sm btn-primary"
                        style="color:white; font-size: 16px"><i class="fas fa-plus"></i>&nbsp; اضافة فاتورة
                    </a>

                    <a class="modal-effect btn btn-sm btn-success" href="{{ url('export_invoices') }}"
                        style="color:white; font-size: 16px"><i class="fas fa-file-download"></i>&nbsp;تصدير اكسيل
                    </a>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($invoice->Value_Status == 1)
                                                <span class="text-white bg-success p-1"
                                                    style="border-radius: 6px">{{ $invoice->Status }}</span>
