                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                <h6>Abdallh Elzayat : SoftWare Enginner</h6>
                                <p>
                                    Phone: +201212384233<br>
                                    Email: abdallhelzayat.dev@gmail.com
                                </p>
                            </div><!-- billed-from -->
                        </div><!-- invoice-header -->
                        <div class="row mg-t-20">
                            <div class="col-md">
                                ...
                                <div class="billed-to">
                                    <h6>Elzayat Company SoftWare</h6>
                                    <p>
                                        Phone: +201212384233<br>
                                        Email: abdallhelzayat.dev@gmail.com
                                    </p>
                            ...
                            <div class="col-md">
                                <label class="tx-gray-600" style="font-weight: bold; font-size: 18px">معلومات
                                    الفاتورة</label>
